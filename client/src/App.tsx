...
import { ping, initToken } from './services/apiService';
        ...
        <div className="w-full">
          ...
          <div className="w-full h-1.5 bg-white/10 rounded-full overflow-hidden">
            <div
              ...
              style={{
                width: `${progress}%`,
                background: 'linear-gradient(90deg, #00d4a0, #00bf8f)',
              }}
            />
          </div>
        </div>
      ...
      {hasError && (
        <div className="fixed bottom-4 left-4 right-4 z-50 flex items-center gap-3 bg-red-900/90 border border-red-500/40 rounded-xl px-4 py-3 text-sm">
          ...
          <button
            ...
            className="text-[#00d4a0] font-bold shrink-0"
          >
            Thử lại
          </button>
        </div>
